...
//    Description:    Validates user login based on username and password. Assumes valid usernames
//                    are email addresses and passwords must be 8-16 characters long with at least one number and
//                    one special character.
//    Methods:
//                    ●   boolean validateUsername(String username): Checks if the username is a valid email
//                        address.w
//                    ●   boolean validatePassword(String password): Checks if the password meets the criteria.
package main;
