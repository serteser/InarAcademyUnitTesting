...
//        Description:  Calculates shipping costs based on weight, destination, and delivery speed.
//        Methods:
//                      ● double calculateCost(double weight, String destination, String deliverySpeed): Returns
